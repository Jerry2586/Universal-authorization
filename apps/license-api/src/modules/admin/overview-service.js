    ...
    adminOverview() {
      ...
      return {
        ...
        licenses: repository.listLicenses(100).map((license) => ({
          ...
          capabilities: JSON.parse(license.plan_capabilities_json ?? '[]'), generation: license.generation,
        ...
        versions: repository.listSourceVersions('appgog').map((version) => ({
          ...
          release_kind: version.release_kind, min_xboard_version: version.min_xboard_version,
