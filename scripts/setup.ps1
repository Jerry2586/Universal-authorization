...
ACTIVATION_SIGNING_PRIVATE_KEY_PATH=./var/keys/ed25519-private.pem
ACTIVATION_SIGNING_PUBLIC_KEY_PATH=./var/keys/ed25519-public.pem
PACKAGE_SIGNING_PRIVATE_KEY_PATH=./var/keys/package-ed25519-private.pem
PACKAGE_SIGNING_PUBLIC_KEY_PATH=./var/keys/package-ed25519-public.pem
NOTIFICATION_SIGNING_PRIVATE_KEY_PATH=./var/keys/notification-ed25519-private.pem
NOTIFICATION_SIGNING_PUBLIC_KEY_PATH=./var/keys/notification-ed25519-public.pem
